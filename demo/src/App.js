    ...
    return (
      <div style={{ position: 'relative', display: 'flex', flexDirection: 'column', height: '100%' }}>
        <Drawer 
          ...
          <MenuItem leftIcon={<DayIcon/>} onTouchTap={() => this.changeMode('day')}>Day</MenuItem>
          <MenuItem leftIcon={<MultipleDaysIcon/>} onTouchTap={() => this.changeMode('3days')}>3 Days</MenuItem>
          <MenuItem leftIcon={<MultipleDaysIcon/>} onTouchTap={() => this.changeMode('week')}>Week</MenuItem>
        </Drawer>
        <AppBar 
